...
CLOUDFRONT_DISTRIBUTION_ID=$(aws cloudformation update-stack --stack-name $UI_STACK_NAME --query "Stacks[0].Outputs[?OutputKey=='CloudFrontDistributionID']|[0].OutputValue" --output text)
cd ui/
