...
//   { path: "/portfolio", element: <Portfolio />, title: "Our Work - MyApp" },
//   { path: "/careers", element: <Careers />, title: "Join Our Team - MyApp" },
//   { path: "/faq", element: <FAQ />, title: "FAQs - MyApp" },
//   { path: "/privacy", element: <PrivacyPolicy />, title: "Privacy Policy - MyApp" },
//   { path: "/terms", element: <Terms />, title: "Terms & Conditions - MyApp" },
];
